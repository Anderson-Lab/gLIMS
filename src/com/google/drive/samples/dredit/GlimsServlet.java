 ...
 */
public class GlimsServlet extends DrEditServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		System.out.println("GlimsServlet");
		...
		if (file != null) {
			String content = null;
			//content = downloadFileContent(service, file);
			if (content == null) {
				content = "";
			}
			resp.setContentType(JSON_MIMETYPE);
			resp.getWriter().print(new ClientFile(file, content, null).toJson());
		} else {
	...
	public void doPut(HttpServletRequest req, HttpServletResponse resp)
		...
		ClientFile clientFile = new ClientFile(req.getReader());
		File file = clientFile.toFile();
		System.out.println(clientFile.content);
		file = service.files().update(
				clientFile.resource_id, file, ByteArrayContent.fromString(
