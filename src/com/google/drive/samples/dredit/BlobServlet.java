...
public class BlobServlet extends DrEditServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("in the blob servlet");
		...
		*/
		...
		file = service.files().get("0B_4L9UB-A6C3UmQ2OWZzOWlqaFU").execute();
		
		// foolin wit da blobstore
		FileService fileService = FileServiceFactory.getFileService();
		
		AppEngineFile appEngineFile = fileService.createNewBlobFile("text/plain");
		
		boolean lock = false;
		FileWriteChannel writeChannel = fileService.openWriteChannel(appEngineFile, lock);
